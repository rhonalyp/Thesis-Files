...
def get_elo(i):
    ...
    S_1 = 1 if setswon1 > setswon2 else 0
    S_2 = 1 if setswon2 > setswon1 else 0
...
file_path = r"C:/Users/rrpar/OneDrive/Desktop/UAAP WVB Eliminations/Season 85 Eliminations.csv"
